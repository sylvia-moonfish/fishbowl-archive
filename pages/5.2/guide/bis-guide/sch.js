...
const pageData = {
  title: "5.2 학자 BiS 가이드",
  description: "파이널 판타지 14 패치 5.2 학자 BiS 가이드.",
};

const gearSets = [
  {
    type: "5.2bis",
    description: "신앙 684 DPS 특화 세트.",
    attributes: {
      main: 0,
      wd: 0,
      ch: 0,
    ...
    dialog: {
      intro:
        "DPS 특화 고화력 장비 세트. 조금 더 높은 신앙을 선호하시는 분들은 신앙 1119 장비 세트 참조.",
      gears: [
        {
          itemId: "augmentedCrystariumCodex",
          materiaIds: ["dh8", "dh8"],
        },
        {
  ...
  },
  {
    ...
    mpRegen: 0,
    dialog: {
      intro: "높은 신앙 장비 세트. 마나 관리에 도움이 됨.",
      gears: [
        {
          itemId: "edenchoirCodex",
          materiaIds: ["ch8", "ch8"],
        },
        {
  ...
  render() {
    ...
    gearSets.forEach((gearSet, gearSetIndex) => {
      ...
      gearSet.attributes.main = Math.floor(
        Math.floor(
          (BisCalculations.level.main * BisCalculations.sch.mnd) / 100
        ) +
        ...
        <Grid container direction="column" spacing={5}>
              ...
              <Grid container direction="column" spacing={5}>
                ...
                <Grid item>
                  <Typography variant="body1">
                    패치 5.2 기준 학자의 Best-in-Slot 장비 세트 목록입니다. 아래
          ...
          <Grid item>
            ...
            <Typography variant="body2">
              학자의 BiS는 신앙 스탯에 따라 갈립니다. 본인이 자주 사망하는
