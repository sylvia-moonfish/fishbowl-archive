...
const pageData = {
  title: "5.1 학자 BiS 가이드",
  description: "파이널 판타지 14 패치 5.1 학자 BiS 가이드.",
};

const gearSets = [
  {
    description: "글쿨 2.41초 신앙 1070 추천 세트.",
    attributes: {
      main: 0,
      wd: 0,
      ch: 0,
    ...
    dialog: {
      intro:
        '학자 최적 글쿨인 2.41초를 맞추고 극대와 직격에 투자한 장비 세트입니다. 무난하게 어느 전투에서든 사용 가능합니다. 음식은 "요술양배추 샐러드"를 섭취합니다.',
      gears: [
        {
          itemId: "wordOfGrace",
          materiaIds: ["dh", "dh"],
  ...
  {
    description: "글쿨 2.39초 신앙 1129 백마 공용 세트.",
    attributes: {
      main: 0,
      wd: 0,
      ch: 0,
    ...
    dialog: {
      intro:
        '백마도사와 공유할 수 있는 장비 세트입니다. 음식은 "쿠쿠루 러스크"를 섭취합니다.',
      gears: [
        {
          itemId: "wordOfGrace",
          materiaIds: ["dh", "dh"],
  ...
  {
    description: "글쿨 2.42초 신앙 1975 절 알렉산더 용.",
    attributes: {
      main: 0,
      wd: 0,
      ch: 0,
    ...
    dialog: {
      intro:
        '의지와 신앙을 최대한 끌어올린 장비 세트입니다. 절 난이도 트라이 시 유용하게 사용할 수 있습니다. 음식은 "요술양배추 샐러드"를 섭취합니다.',
      gears: [
        {
          itemId: "wordOfGrace",
          materiaIds: ["sps", "sps"],
...
class Sch extends PageComponent {
  constructor(props) {
    super(props);
              ...
              <Grid container direction="column" spacing={5}>
                  ...
                  >
                    <Grid item>
                      <img
                        ...
                        src="/icons/job-crystals/sch.png"
                      />
                    </Grid>
                  </Grid>
                </Grid>
                <Grid item>
                  <Typography variant="body1">
                    패치 5.1 기준 학자의 Best-in-Slot 장비 세트 목록입니다. 아래
...
export default withStyles(styles)(withRouter(Sch));
