...
const pageData = {
  title: "5.1 적마도사 BiS 가이드",
  description: "파이널 판타지 14 패치 5.1 적마도사 BiS 가이드.",
};
...
class Rdm extends PageComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    gearSets.forEach((gearSet) => {
      gearSet.attributes.main = Math.floor(
        Math.floor(
          (BisCalculations.level.main * BisCalculations.rdm.int) / 100
        ) +
                  ...
                  >
                    <Grid item>
                      <img
                        ...
                        src="/icons/job-crystals/rdm.png"
                      />
                    </Grid>
                  </Grid>
                </Grid>
...
export default withStyles(styles)(withRouter(Rdm));
