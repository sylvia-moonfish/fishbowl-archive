...
import CraftActions from "../../../data/5.1/craft-actions";
import CraftItems from "../../../data/5.1/craft-items";
import SiteInfo from "../../../data/site-info";
import ExpansionPanels from "../../../src/components/common/expansion-panels";
import PanelDivider from "../../../src/components/common/panel-divider";
import CraftActionDisplay from "../../../src/components/craft-guide/craft-action-display";
import CraftGearDisplay from "../../../src/components/craft-guide/craft-gear-display";
import CraftGearStats from "../../../src/components/craft-guide/craft-gear-stats";
import CraftMaterialDisplay from "../../../src/components/craft-guide/craft-material-display";
          ...
          <Grid item>
            <Container maxWidth="md">
              <Grid container direction="column" spacing={5}>
                            ...
                            actionMacro={[
                              ...
                              },
                              {
                                ...
                                lines: [
                                  {
                                    type: "action",
                                    value: "byregotsBlessing",
                                  },
                                  {
                                    type: "action",
                                    value: "basicSynthesis",
                                  },
                                  {
                                    type: "prompt",
                                    value: "endOfCrafting",
                            ...
                            craftMaterials={[
                              {
                                ...
                                materials: [
                                  {
                                    id: "dwarvenMythrilEarCuffs",
                                    amount: 1,
                                    hq: true,
                                  },
                                  {
                                    id: "dwarvenMythrilChoker",
                                    amount: 1,
                                    hq: true,
                                  },
                                  {
                                    id: "dwarvenMythrilBracelets",
                                    amount: 1,
                                    hq: true,
                                  },
                                  {
                                    id: "dwarvenMythrilRing",
                                    amount: 2,
                                    hq: true,
                                  },
                                ],
                            ...
                            craftMaterials={[
                              {
                                ...
                                materials: [
                                  {
                                    id: "facetHatOfCrafting",
                                    amount: 1,
                                    hq: true,
                                  },
                                  {
                                    id: "facetGlovesOfCrafting",
                                    amount: 1,
                                    hq: true,
                                  },
                                  {
                                    id: "facetBootsOfCrafting",
                                    amount: 1,
                                    hq: true,
                                  },
                                ],
                ...
                <CraftGearDisplay gearSet={gearSets[6]} Items={CraftItems} />
                <CraftGearStats gearSet={gearSets[6]} Items={CraftItems} />
                <Grid item>
                  <Typography variant="body2">
